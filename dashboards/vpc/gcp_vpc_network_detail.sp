dashboard "gcp_vpc_network_detail" {
  ...
  documentation = file("./dashboards/vpc/docs/vpc_network_detail.md")
  ...
  container {
    ...
    card {
      width = 2
      query = query.gcp_vpc_network_mtu
      args = {
  ...
  container {
    ...
    container {
      ...
      table {
        ...
        query = query.gcp_vpc_network_subnet
        args = {
          name = self.input.vpc_name.value
        }
      }
